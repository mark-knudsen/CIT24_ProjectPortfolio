...
CREATE TABLE profession
(
profession_ID serial NOT NULL UNIQUE, --Denne skal vaere NOT NULL UNIQUE, da vi i primaryproffession specificerer den som foreign key
...
(
title_ID varchar(10) primary key,
average_rating numeric(3,1), ---aendret denne til 3,1, da man ellers kun kan vise max 9.9
